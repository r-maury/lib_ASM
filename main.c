...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2015/02/11 17:27:43 by bfrimin           #+#    #+#             */
/*   Updated: 2015/03/20 18:18:59 by rmaury           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			main(void)
{
 ...
 //    /* FT_TOUPPER */
   ...
   for ((i = -1000000); i < 1000000; i++)
   {
       ...
       {
           printf("ft_isblank error at i=%d [%d/%d]\n", i, ft_isblank(i), isblank(i));
           c++;
       }
   }
   if (!c)
       printf("ft_isblank: OK !\n\n");
   ...
   for ((i = -1000000); i < 1000000; i++)
   {
       ...
       {
           printf("ft_isspace error at i=%d [%d/%d]\n", i, ft_isspace(i), isspace(i));
           c++;
       }
   }
   if (!c)
  ...
  printf("[%c][%c][%c][%c][%c][%c][%c][%c][%c][%c][%c][%c][%c][%c]\n",
      ...
      s2[7], s2[8], s2[9], s2[10], s2[11], s2[12], s2[13]);
  ft_strclr(s2);
  printf("[%c][%c][%c][%c][%c][%c][%c][%c][%c][%c][%c][%c][%c][%c]\n",
      s2[0], s2[1], s2[2], s2[3], s2[4], s2[5], s2[6],
      s2[7], s2[8], s2[9], s2[10], s2[11], s2[12], s2[13]);
